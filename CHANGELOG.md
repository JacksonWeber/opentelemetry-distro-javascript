...
### Bugs Fixed
- Correct AzureChatOpenAI request-model attribution and chat span names for bare, configured, and tool-bound LangChain calls without emitting LangChain's unrelated `gpt-3.5-turbo` default.
