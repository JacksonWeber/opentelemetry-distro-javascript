...
### Bugs Fixed
- Apply the AzureChatOpenAI request-model workaround to configured and tool-bound LangChain calls. [#225](https://github.com/microsoft/opentelemetry-distro-javascript/pull/225)
