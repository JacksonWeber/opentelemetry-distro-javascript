...
### Bugs Fixed
- Preserve the request model reported by LangChain for AzureChatOpenAI runs instead of replacing it with the response model. [#225](https://github.com/microsoft/opentelemetry-distro-javascript/pull/225)
